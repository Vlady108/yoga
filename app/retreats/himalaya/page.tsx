          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="bg-[#3a3a35] text-white p-6 sm:p-8 text-center">
              <p className="text-sm sm:text-base font-light leading-relaxed text-white/90 max-w-2xl mx-auto">
                Точность и дисциплина 19-летней практики Влада — как работать с телом, дыханием и энергией — встречается с глубиной 25-летнего духовного пути Дарьи — как эту энергию почувствовать, принять и интегрировать в жизнь. Один без другого даёт половину. Вместе — полный путь.
              </p>
            </div>
          </div>
        </section>
